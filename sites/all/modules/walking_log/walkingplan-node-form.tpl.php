  ...
  <div class="walking-log-nav">
	...
	<?php }  ?>
      ...
      <div>
			...
			<?php print drupal_render($form['field_year_planned']); ?>
        </div>
		...
		<div>
			<a href="<?php echo url('walking_log/plans',array('fragment'=>'progress_content_block'));?>"><img class="add-monthly-plan" src="<?php echo url($path.'/images/view-plan.png'); ?>" /></a>
		</div>
		<?php endif; ?>
