$(document).ready(function(){
		...
		$('.write-to-frnd-container #radio_1').attr('checked',true);
		...
		$('.you-and-your-meds-banner').wrapAll('<a href="/you-and-your-meds"></a>');
		$('.digital-diary-banner').wrapAll('<a href="/digital-diary"></a>');
		$('.getting-better-banner').wrapAll('<a href="/getting-better"></a>');
		...
		$('.different-treatments-banner').wrapAll('<a href="/different-treatments"></a>');
		$('.friends-family-banner').wrapAll('<a href="/friends-family"></a>');
...
function updateCalendar(){
  ...
  if(date === lastDay) {
      $("#block-block-79 .content p a img").src = "/sites/default/files/WallpaperHome_Widget_"+monthNames[month+1]+".png";
      $("#block-block-65 .content p p a img").src = "/sites/default/files/Wallpaper_Widget_"+monthNames[month+1]+".png";
      $("img#calendar .size div:nth-child(5) img").src = "/sites/default/files/"+monthNames[month+1]+"-800.jpg";
      $(".size div:first-child img").src = "/sites/default/files/"+monthNames[month+1]+"-1680.jpg";
      $(".size div:nth-child(2)img").src = "/sites/default/files/"+monthNames[month+1]+"-1280.jpg";
      $(".size div:nth-child(3)img").src = "/sites/default/files/"+monthNames[month+1]+"-1266.jpg";
      $(".size div:nth-child(4)img").src = "/sites/default/files/"+monthNames[month+1]+"-1024.jpg";
	  if(typeof console !== "undefined"){
		console.log(monthNames[month+1]);
	  }
   } else {if(typeof console !== "undefined"){console.log('nooo')}}
}updateCalendar();
