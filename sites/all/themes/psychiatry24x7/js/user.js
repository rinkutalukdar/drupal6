  ...
  $("input.password-field:not(.password-processed)", context).each(function() {
    ...
    var passwordCheck = function () {
	  ...
	  if(result.message!=''){
		...
		$('<span class="err-msg-ctr"><span class="msg-spans">'+result.message+"</span></span>").appendTo("#error_msg");
	  }
...
Drupal.evaluatePasswordStrength = function(value) {
  ...
  // Check if length is less than 6 characters.
	...
	msg = Drupal.t('It is recommended to use at least six characters with numbers, punctuation and letters.');
  }
