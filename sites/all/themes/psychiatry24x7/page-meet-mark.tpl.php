					...
					<!--<section id="wp_area_wrapper">-->
						<!--<div class="video small" id="wp_video_wrapper">-->
							<!-- Start of Brightcove Player -->
								...
								<object id="myExperience2725457548001" class="BrightcoveExperience">
								  <param name="bgcolor" value="#FFFFFF" />
								  <param name="width" value="725" />
								  <param name="height" value="408" />
								  <param name="playerID" value="3266798256001" />
								  <param name="playerKey" value="AQ~~,AAABV5OycoE~,X9E4Chm4u-_o2gF0yM_lkMKcTGzcTyMu" />
								  <param name="isVid" value="true" />
								  <param name="isUI" value="true" />
								  <param name="dynamicStreaming" value="true" />
								  
								  <param name="@videoPlayer" value="2725457548001" />
								</object>
