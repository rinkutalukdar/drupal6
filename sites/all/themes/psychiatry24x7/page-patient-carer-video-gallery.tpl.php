...
print $scripts;
 ...
 $(document).ready(function() {
   if ($("#header_left li.first a").text() == "Home") {
     ...
     //$("#header_left li.first a").attr("href", "/homepage");
   }
...
<!-- Header Starts here //-->
  ...
  <div id="body_container" class="<?php print $navigation_body_color; ?>">
    <div style="padding-left:26px;"><?php print $breadcrumb; ?></div>
	<div class="patient-carer-title" style="padding-left:26px;"><?php if ($title): print '<h1>'. $title .'</h1>'; endif; ?></div>
    <div id="body_right" class="patient-search-container">
    ...
    <div id="body_bmiddle" class="decision_trees" style="padding-left:26px;">
