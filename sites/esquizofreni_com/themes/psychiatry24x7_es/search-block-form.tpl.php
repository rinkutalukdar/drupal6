 ...
 */
	...
	$search["submit"]	=	str_replace('input type="submit"', 'input type="image" src="'.$images_path.'icon_go.gif" ', $search["submit"]);
	
	/* Place the HTML of the design to the search form */
	$search['search_block_form'] = '<div id="search_txt"><img src="'.$images_path.'hd_search.gif" alt="'.t("Search").'" title="'.t("Search").'" /></div>
