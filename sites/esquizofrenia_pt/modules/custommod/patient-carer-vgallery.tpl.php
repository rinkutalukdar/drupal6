...
<div class="patient-gallery-container">
	<div class="patient-carer-category patient-carer-category-road-recovery"> O caminho para a recuperação do ponto de vista do cuidador<!--<img src='/sites/default/files/the-road-to-recovery.png' /> --></div>
	<div class="patient-carer-gallery road-recovery"><?php print views_embed_view('patient_carer_gallery', 'default',307); ?></div>
</div>
<div class="patient-gallery-container">
	<div class="patient-carer-category patient-carer-category-impact-schizo"> O impacto da esquizofrenia nos amigos e familiares<!--<img src='/sites/default/files/the-imapct-of-schizo.png' /> --></div>
	<div class="patient-carer-gallery impact-schizo"><?php print views_embed_view('patient_carer_gallery', 'default',308); ?></div>
</div>
<div class="patient-gallery-container">
	<div class="patient-carer-category patient-carer-category-looking-fwd"> Olhar em frente:<br /> Ronen partilha as suas esperanças e planos para o futuro<!--<img src='/sites/default/files/looking-fwd.png' /> --></div>
