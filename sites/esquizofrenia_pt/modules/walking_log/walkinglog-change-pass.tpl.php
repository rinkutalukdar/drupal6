	...
	<div class="login-walk-container-parent">
		<div class="login-walk-container">
			...
			<div class='user-login-coverup'>	
				<img src="<?php print url(drupal_get_path('theme','psychiatry24x7').'/images/change-pass.png'); ?>" />
			</div>
			<div class="user-login-container">
				
				  <?php print drupal_render($form['name']); ?>
				  <?php print drupal_render($form['pass']); ?>
				  <?php print drupal_render($form['new_pass']); ?>
				  <?php print drupal_render($form['confirm_pass']); ?>
			</div>
			</div>
		...
		<div id="error_msg">
		<?php if($messages):  ?>
					<span><?php print $messages; ?></span><img src="<?php print url(drupal_get_path('theme','psychiatry24x7').'/images/bubble-small.png'); ?>" />
		<?php endif; ?>
		</div>
	</div>
