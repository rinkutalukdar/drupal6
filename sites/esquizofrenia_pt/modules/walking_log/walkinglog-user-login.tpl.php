		...
		<div class="login-walk-container">
			<div class="user-login-container-top">
				<div class='user-login-coverup'>	
					<img src="<?php print url(drupal_get_path('theme','psychiatry24x7').'/images/log-in-account.png'); ?>" />
				</div>
	...
	<?php print drupal_render($form['submit']); ?>
		...
		<div class="additional-links">
			<div class='forgot-password-link'>
				<?php print l(t('Forgotten password?'),'user/password'); ?>
			</div>
			<div class='change-password-link'>
				<?php print l(t('Change password?'),'user/changepassword'); ?>
			</div>
		</div>
  </div>
</div>
